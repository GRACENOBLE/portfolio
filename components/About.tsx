...
export default function About() {
  return (
    <section  className="py-40 bg-black scroll-smooth transition-all ease-in-out" id="About">
      <Container>
        <div className="flex flex-col justify-center  text-white">
          ...
          <br />
          <br />
          <h2 className="text-white text-4xl ps-10">What I do</h2>
          <br />
          <p className="ps-20">
          ...
          <br />
          <br />
          <h2 className="text-white text-4xl ps-10">Where i am stationed</h2>
          <br />
          <p className="ps-20">
          ...
          <br />
          <br />
          <h2 className="text-white text-4xl ps-10">
