...
const ProjectShowcaseCard = () => {
  return (
    <div className="p-8 py-6 isolate relative overflow-hidden rounded-2xl aspect-9/12 bg-white/5 hover:cursor-pointer active:cursor-grabbing  group transition-all ease-in-out duration-300">
      <Image
        src={"/images/one.jpg"}
        alt={""}
        width={500}
        height={500}
        className="absolute -z-1 h-full object-cover left-0 top-0 group-hover:opacity-30 transition-all ease-in-out duration-300 unselectable"
        draggable="false"
      />
